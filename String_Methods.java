...
//  toString() : The toString() method in Java is used to return a string representation of an object.
//               When you print an object, By default, it provides address of that object stored in computer memory,
//               but you can override toString() method to convert the object into a readable string.

        wheel pr = new wheel();    // Object for wheel class

        System.out.println(pr.toString());   // prints the address of the object stored in memory of computer
        System.out.println(pr);   // as it convert the object into a readable string.
...
class wheel{
    ...
    String model = "911 GT3 RS";
    String color = "Yellow";
    int price  = 120;


    public String toString() {      // it converts the address object readable String
